...
// Check multiple ways to detect Vitest environment
const isVitest = 
  (typeof process !== 'undefined' && process.env.VITEST) ||
  (typeof globalThis !== 'undefined' && globalThis.__vitest_worker__) ||
  (typeof process !== 'undefined' && process.argv.some(arg => arg.includes('vitest')))

if (isVitest) {
  // Use synchronous imports since this is a setup file
  // Vitest will handle the async nature
